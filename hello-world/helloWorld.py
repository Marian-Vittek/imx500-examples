...
## In fact, in this case the class is not a neural network at all. We simply construct 'hello world'
## message in it.
...
class NeuralNetwork(nn.Module):
    ...
    def forward(self, input): 
        ...
        oo = torch.add(oo, zz);
        # return the 1D tensor with the message. In general I can return 2D or 3D tensor as well.
        return oo
